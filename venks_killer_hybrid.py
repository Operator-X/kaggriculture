...
# Adaptive Sabotage Agent with a 1-hour schedule shift to prevent opponent front-running.
# Plays the optimal venks schedule starting at Step 0 instead of Step 1 to gain a 1-hour head start.
...
# Shift entire schedule by -1 hour to start at Step 0
EARLY_ACTIONS = {k - 1: v for k, v in ORIG_ACTIONS.items() if k > 0}

# Shift sell steps by -1 hour accordingly
VENKS_SELL_STEPS = {
    # Melon
    256: ["MELON"], 258: ["MELON"], 259: ["MELON"], 261: ["MELON"], 264: ["MELON"],
    498: ["MELON"], 503: ["MELON"], 504: ["MELON"], 528: ["MELON", "STRAWBERRY", "MILK"],
    
    # Strawberry
    424: ["STRAWBERRY"], 430: ["STRAWBERRY"], 432: ["STRAWBERRY", "MILK", "WOOL"],
    456: ["STRAWBERRY", "MILK"], 470: ["STRAWBERRY"],
    480: ["STRAWBERRY", "MILK"], 518: ["STRAWBERRY"], 527: ["STRAWBERRY"],
    552: ["STRAWBERRY", "MILK"], 568: ["STRAWBERRY"], 571: ["STRAWBERRY"],
    572: ["STRAWBERRY"], 574: ["STRAWBERRY"], 575: ["STRAWBERRY"],
    576: ["STRAWBERRY", "MILK"], 600: ["STRAWBERRY", "WOOL"],
    618: ["STRAWBERRY"], 621: ["STRAWBERRY"], 624: ["STRAWBERRY", "MILK"],
    648: ["STRAWBERRY", "MILK", "WOOL"], 668: ["STRAWBERRY"], 672: ["STRAWBERRY"],
    
    # Milk/Wool
    168: ["WOOL"], 216: ["MILK"],
    240: ["WOOL"], 312: ["MILK", "WOOL"],
    360: ["MILK"], 384: ["MILK", "WOOL"],
    408: ["MILK"], 451: ["MILK", "WOOL"], 472: ["MILK"],
    474: ["MILK"], 496: ["MILK", "WOOL"], 520: ["MILK", "WOOL"],
    525: ["MILK", "WOOL"], 564: ["MILK", "WOOL"], 565: ["WOOL"], 566: ["MILK", "WOOL"],
    592: ["MILK"], 594: ["MILK"], 598: ["WOOL"],
    616: ["MILK"], 
    664: ["MILK", "WOOL"], 665: ["MILK"], 
    669: ["MILK"], 671: ["WOOL"], 
    696: ["MILK"],
    
    # End game sells
    714: ["WOOL", "WHEAT"], 715: ["MILK", "WOOL", "WHEAT", "FERTILIZER"],
    716: ["MILK", "WHEAT", "WOOL", "FERTILIZER"], 717: ["WHEAT"], 718: ["WHEAT"]
}

IS_VENKS_MATCH = True

def agent(observation, configuration=None):
    global IS_VENKS_MATCH
    ...
    # Because of the 1-hour shift, we check at Step 47 (Day 1, Hour 23) if they have exactly 12 Melon tiles.
    if step == 47:
    ...
    # ONLY deploy the front-running sells if we are playing against a venks clone!
    if IS_VENKS_MATCH:
        next_step = step + 1
    ...
    # Keep market orders within the limits (max 10)
